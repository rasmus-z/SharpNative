...
namespace SharpNative.Compiler
{
    internal static class WriteInitializer
    {
        public static void Go(OutputWriter writer, InitializerExpressionSyntax initializer)
        {
            ...
            if (CSharpExtensions.IsKind(initializer, SyntaxKind.CollectionInitializerExpression) ||
                CSharpExtensions.IsKind(initializer, SyntaxKind.ArrayInitializerExpression))
            {
